...
int main() {
    ...
    xtechnical::MW<double> iMW(30);
    xtechnical::MMA<double> iMMA(5);
    xtechnical::SMA<double> iSMA(5);
    xtechnical::AMA<double> iAMA(10);
    xtechnical::NoLagMa<double> iNoLagMa(10);
    xtechnical::RoC<double> iRoC(3);
    xtechnical::VWMA<double> iVWMA(20);
    ...
    for(int i = 1; i <= 50; ++i) {
        ...
        if(err_std_dev == 0) {
            ...
            iMW.compare_data(
                angle_value,
                xtechnical::common::CALCULATE_ANGLE,
                true,
