...
int main() {
    ...
    double temp = 0;
    xtechnical::calculate_sma(test_data, temp, 4, 1);
    std::cout << "calculate_sma:" << std::endl;
    std::cout << temp << std::endl;
    xtechnical::calculate_std_dev(test_data, temp, 4, 1);
    std::cout << "calculate_std_dev:" << std::endl;
    std::cout << temp << std::endl;
    double temp2 = 0;
    xtechnical::calculate_std_dev_and_mean(test_data, temp, temp2, 4, 1);
    ...
    xtechnical::calc_ring_bollinger(test_data2, out_tl,  out_ml, out_bl, 4, 2);
    ...
    xtechnical::calc_ring_rsi(test_data2, out_rsi, 4);
